...
- **Architecture:** Hilt for DI, Coroutines with Flow, Material Design 3

### 📚 [LanguageDecks](https://github.com/ogzhntutucu/LanguageDecks)
Educational flashcard app for improving language skills
